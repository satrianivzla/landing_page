...
<div class="row">
    <div class="col-md-3">
        <div class="list-group">
            <a href="<?php echo base_url('admin/slider'); ?>" class="list-group-item list-group-item-action active">Slider</a>
    ...
    <div class="col-md-9">
        ...
        <?php echo form_open_multipart('admin/upload_slider_image');?>
        ...
        <table class="table table-striped">
            ...
            <tbody>
                <tr>
                    <td><img src="https://via.placeholder.com/150x50.png?text=Image+1" class="img-thumbnail"></td>
                    <td><a href="#" class="btn btn-danger">Delete</a></td>
                </tr>
                <tr>
                    <td><img src="https://via.placeholder.com/150x50.png?text=Image+2" class="img-thumbnail"></td>
                    <td><a href="#" class="btn btn-danger">Delete</a></td>
                </tr>
                <tr>
                    <td><img src="https://via.placeholder.com/150x50.png?text=Image+3" class="img-thumbnail"></td>
                    <td><a href="#" class="btn btn-danger">Delete</a></td>
                </tr>
            </tbody>
        </table>
